    ...
    <>
        ...
        <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
                ...
                <TextField onChange={handleChangeChannelName} autoFocus fullWidth margin='dense' label='채널명' type='text' variant='standard' autoComplete='off' />
                <TextField onChange={handleChangeChannelDetail} autoFocus fullWidth margin='dense' label='설명' type='text' variant='standard' autoComplete='off' />
            </DialogContent>
            <DialogActions>
